...
const ServicesClinicalExperience = () => {
	...
	return (
		<>
			<ServicesTitleClear title='Clinical Experience' />
			<div className='flex flex-col items-center gap-y-12 -mt-1 '>
...
export { ServicesClinicalExperience };
